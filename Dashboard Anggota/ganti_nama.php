...
// Ambil Foto Profil (DIPERBAIKI DISINI)
...
// GANTI PATH FOLDER JADI "../uploads/foto_profil/" SESUAI DENGAN STRUCTUR FOLDER KM
if (!empty($foto_session) && file_exists("../uploads/foto_profil/" . $foto_session)) {
    // Tambahkan ?t= time() agar browser tidak cache foto lama (auto update)
    $foto_profil = "../uploads/foto_profil/" . $foto_session . "?t=" . time();
}
?>
